...
run:
	./i2c_to_wb.out
	gtkwave -a tb_top.gtkw  tb_top.vcd &

model: tb_dut.h tb_dut.cpp glitch_generator.o wb_slave_model.o i2c_master_model.o
	$(CXX) $(CXXFLAGS) Model/tb_model.cpp tb_dut.h tb_dut.cpp \
...
glitch_filter.o: glitch_filter/glitch_filter.cpp glitch_filter/glitch_filter.h
	$(CXX) $(CXXFLAGS) -c glitch_filter/glitch_filter.cpp glitch_filter/glitch_filter.h $(LDLIBS)
